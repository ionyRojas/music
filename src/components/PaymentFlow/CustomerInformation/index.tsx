...
const GetFormikValues = (
  ...
  return useFormik({
    ...
    validationSchema: Yup.object({
      firstName: Yup.string().min(3, 'Must be 3 characters minimum').required(),
      lastName: Yup.string().min(5, 'Must be 3 characters minimum').required(),
...
function CustomerInformation(props: Props) {
  ...
  function handlePhoneChange(phoneValue: string): void {
      ...
      <form onSubmit={formik.handleSubmit}>
        <Flex display={{ base: 'block', lg: 'flex' }} mt="10">
          ...
          >
            ...
            />
            <FormErrorMessage color="red.600" data-testid="first-name-error">
        ...
        <Flex mt="8">
          ...
          <Spacer />
          <FormControl flex="2">
            <FormLabel htmlFor="outside_us">Outside US</FormLabel>
            <Switch
              {...formik.getFieldProps('outsideUs')}
              size="lg"
              id="outside_us"
            />
          </FormControl>
        ...
        <Flex {...styles.buttonsWrapper}>
          ...
          <Button {...styles.buttonBack} onClick={handleBack}>
            Back
          </Button>
        </Flex>
      </form>
