...
const ImagesURLS = {
  ...
  'american-express':
    'https://graffica.info/wp-content/uploads/2018/04/american-express-graphic-design-3.jpg',
  mastercard:
...
const SelectedPlan = (props: SelectedPlanProps) => {
  ...
  return (
    <>
      <Heading {...styles.heading} textAlign="center">
        Selected Plan
      </Heading>
      <Flex {...styles.selectedPlanFlex} flexWrap="wrap">
        <Text {...styles.textV1} textTransform="uppercase" textAlign="center">
          {selectedPlan.name}
        </Text>
        <Text {...styles.textv2} textAlign="center">
          $ {selectedPlan.price} USD / mo
        </Text>
      </Flex>
    </>
  );
...
const TotalCalculation = (props: TotalCalculationProps) => {
  ...
  return (
    <Flex {...styles.glassmorphism} {...styles.flexBox} flexWrap="wrap">
...
const CreditCardPreview = (props: CreditCardsPreviewProps) => {
  const {
    creditCardInfo: { cardNumber, nameOnCard, expiredDate, cardType },
    selectedPlan,
    tax,
    tabIndex,
  } = props;
  ...
  return (
    <>
      <Heading size="md" color="white" mb="8" textAlign="center">
        Credit card preview
      </Heading>
      <Flex
      ...
      >
        ...
        <Image
          position="absolute"
          w="80px"
          bottom={{ sm: '7', lg: '70%', xl: '7' }}
          right={{ sm: '7', lg: '3', xl: '7' }}
          src={imageUrl}
        />
      </Flex>
      <Heading size="md" color="white" mt="12" mb="8" textAlign="center">
        Order Summary
      </Heading>
      <Box
        {...styles.glassmorphism}
...
function Summary(props: Props) {
  ...
  useEffect(() => {
    async function fetchData() {
      const { data } = await axios.get(
        'https://run.mocky.io/v3/3d22a479-6587-444c-b2e4-1ad5776355fa',
      );
  ...
  return (
    <div>
      ...
      />
      <CreditCardPreview
        creditCardInfo={appState.creditCard}
        selectedPlan={appState.selectedPlan}
        tabIndex={tabIndex}
        tax={tax}
      />
